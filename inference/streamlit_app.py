...
# Heading to generate a random prompt sample
...
# Button to generate a random sample on the right side
if st.sidebar.button("Fetch Random Article Content"):
    with st.spinner("Generating Random Sample..."):
        ...
        random_prompt = dataset["test"][random_index]["article"]
...
if show_note:
    st.sidebar.markdown("Note: The above sample has been fetched from [CCDV Arxiv Summarization](https://huggingface.co/datasets/ccdv/arxiv-summarization)")
